...
const REPORTS: ReportMeta[] = [
  ...
  {
    id:          'wage-cost-per-pair',
    title:       'Wage Cost Per Pair',
    description: 'Total wage cost breakdown per pair produced — analysed by line, contractor, and task type.',
    filterTags:  ['Week'],
    icon:        DollarSign,
    csvParams:   { csv: '1', week_ref: currentWeekRef() },
    csvFilename: `wage-cost-per-pair-${currentWeekRef()}.csv`,
    accentColor: 'bg-teal-50 text-teal-700 border-teal-100',
  },
  {
    id:          'line-productivity',
    title:       'Line Productivity',
    description: 'Output, efficiency, and capacity utilisation per production line over a selected period.',
    filterTags:  ['Week', 'Line'],
    icon:        BarChart2,
    csvParams:   { csv: '1', week_ref: currentWeekRef() },
    csvFilename: `line-productivity-${currentWeekRef()}.csv`,
    accentColor: 'bg-indigo-50 text-indigo-700 border-indigo-100',
  },
  {
    id:          'shift-adjustments',
    title:       'Shift Adjustments',
    description: 'Confirmed and pending cross-shift movements with overtime flags and authorisation trail.',
    filterTags:  ['Week'],
    icon:        Clock,
    csvParams:   { csv: '1', week_ref: currentWeekRef() },
    csvFilename: `shift-adjustments-${currentWeekRef()}.csv`,
    accentColor: 'bg-orange-50 text-orange-700 border-orange-100',
  },
  {
    id:          'ghost-worker',
    title:       'Ghost Worker Report',
    description: 'Production anomaly and biometric mismatch flags for fraud detection and risk review.',
    filterTags:  ['Week'],
    icon:        AlertTriangle,
    csvParams:   { csv: '1', week_ref: currentWeekRef() },
    csvFilename: `ghost-worker-${currentWeekRef()}.csv`,
    accentColor: 'bg-red-50 text-red-700 border-red-100',
  },
  {
    id:          'rejection-analysis',
    title:       'Rejection Analysis',
    description: 'QC rejection rates by worker, line, and defect type with full penalty deduction breakdown.',
    filterTags:  ['Week', 'Contractor'],
    icon:        XCircle,
    csvParams:   { csv: '1', week_ref: currentWeekRef() },
    csvFilename: `rejection-analysis-${currentWeekRef()}.csv`,
    accentColor: 'bg-pink-50 text-pink-700 border-pink-100',
  },
  {
    id:          'annual-payroll-summary',
    title:       'Annual Payroll Summary',
    description: 'Full-year gross earnings, statutory deductions, and net pay aggregates by worker and contractor.',
    filterTags:  ['Year'],
    icon:        FileText,
    csvParams:   { csv: '1', year: String(new Date().getFullYear()) },
    csvFilename: `annual-payroll-summary-${new Date().getFullYear()}.csv`,
